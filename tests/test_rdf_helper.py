...
from ifc2rdf_webapp.tools.rdf_helper import (
    get_instance_id_from_rdf_resource, get_instances_of_rdf_resource,
    get_rdf_entities, get_triples_based_on_instance_name,
    get_triples_based_on_instance_uri)
...
def test_should_return_triples_based_on_instance_name() -> None:
    ...
    test_graph_path = "tests/resources/test_graph.ttl"
    test_graph = Graph().parse(source=test_graph_path, format="turtle")
    actually_constructed_graph = get_triples_based_on_instance_name(
        test_graph, instance_type, "Building"
    )
...
def test_should_return_triples_based_on_instance_uri() -> None:
    test_graph_path = "tests/resources/test_graph.ttl"
    test_graph = Graph().parse(source=test_graph_path, format="turtle")
    actually_constructed_graph = get_triples_based_on_instance_uri(
